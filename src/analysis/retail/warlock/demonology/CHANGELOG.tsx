...
export default [
  change(date(2025, 8, 17), <>Added support for patch 11.2 with TWW Season 3 Manaforge Omega tier sets. Implemented tracking for both Diabolist (<SpellLink spell={SPELLS.DEMONIC_OCULUS_BUFF}/>) and Soul Harvester (<SpellLink spell={SPELLS.SHADOW_OF_DEATH_CAST}/>) hero talent tier bonuses. Added <SpellLink spell={SPELLS.EYE_BLAST}/> spell ID for tier set mechanics.</>, Leftyxiv),
