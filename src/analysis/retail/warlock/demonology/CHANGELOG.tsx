...
export default [
  change(date(2025, 8, 20), <>Added support for patch 11.2 with TWW Season 3 Manaforge Omega tier sets. Implemented tracking for both Diabolist (<SpellLink spell={SPELLS.DEMONIC_OCULUS_BUFF}/> with <SpellLink spell={SPELLS.EYE_BLAST}/>) and Soul Harvester (<SpellLink spell={SPELLS.SHADOW_OF_DEATH_CAST}/> with <SpellLink spell={SPELLS.SOUL_SWIPE}/>) hero talent tier bonuses.</>, Leftyxiv),
