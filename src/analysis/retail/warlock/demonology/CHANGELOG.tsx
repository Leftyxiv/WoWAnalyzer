...
export default [
  change(date(2025, 7, 20), <>Fixed <SpellLink spell={TALENTS_WARLOCK.SUMMON_DEMONIC_TYRANT_TALENT}/> to track hounds (Charhound/Gloomhound), added TWW Season 2 tier set statistics, and enhanced guide with <SpellLink spell={TALENTS_WARLOCK.DOOM_TALENT}/> and Always Be Casting sections</>, Leftyxiv),
